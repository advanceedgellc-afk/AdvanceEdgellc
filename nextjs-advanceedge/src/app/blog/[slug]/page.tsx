...
// ✅ FIXED: generateMetadata with null check
...
// ✅ FIXED: generateStaticParams with error handling
...
export default async function BlogPost({ params }: Props) {
  try {
    const resolvedParams = await params;
    const post = await client.fetch<SanityDocument | null>(POST_QUERY, resolvedParams, options);
    ...
    // ✅ FIXED: Safe image URL generation
