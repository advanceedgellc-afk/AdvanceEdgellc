...
const faqItems = [
  {
    id: 1,
    question:
      "What are the must-have features for a high-converting law firm website?",
    answer: `A high-converting law firm website should have:
...
We build websites designed to convert visitors into clients.`,
  ...
  {
    id: 2,
    question: "How does SEO help law firms rank higher on Google?",
    answer: `SEO improves your law firm’s visibility by optimizing:
                    ...
                    {activeId === item.id && (
                      ...
                      >
                        <motion.div
                          ...
                          exit={{ y: -10, opacity: 0 }}
                        >
                          <p className="font-dm text-slate-300 leading-relaxed text-sm md:text-base whitespace-pre-line">
                            {item.answer}
                          </p>
                        </motion.div>
                      </motion.div>
