...
export default function HeroSection() {
  ...
  return (
    <section className="bg-gradient-to-br from-[#1a1a2e] to-[#16213e] min-h-[600px] md:min-h-[600px] flex items-center justify-center px-5 pb-0 pt-24 md:pb-0 md:pt-28">
      <div className="max-w-6xl w-full">
        <div className="animate-fadeIn">
          <h1   className="text-4xl md:text-5xl lg:text-5xl font-light  text-white mb-6 tracking-tight">
          Dominate the Digital Space With High Impact Web Development & Marketing That Drives Results!
            
          </h1>

          <p className="text-lg md:text-xl text-gray-400 leading-relaxed mb-8 max-w-5xl">
          From Stunning Websites to Targeted Marketing – We Build, Optimize & Scale Your Brand for Success!
          </p>
