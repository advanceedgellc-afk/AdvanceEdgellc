...
const faqItems = [
  {
    ...
    answer:
      "Legal intake specialists give small firms and solo attorneys professional coverage without full‑time overhead. They answer calls during court appearances, qualify cases against your criteria, send retainers for e‑signature, and document everything in your system, so you never miss a case while you're in trial or with clients.",
  },
  {
    id: 2,
    question: "Can intake specialists handle multiple practice areas like family law and immigration?",
    answer:
      "Yes, our specialists are trained across all practice areas, including Mass Tort, PI, MVA, family law, estate planning, immigration, and more. They use your specific qualification criteria for each practice area, whether it's financial details for family law, timelines for immigration, or medical comorbidities for Mass Tort.",
  },
  {
    id: 3,
    question: "Do legal intake specialists help with retainer signing and client onboarding?",
    answer:
      "Absolutely. Qualified claimants receive retainers via text/email for immediate e‑signature, plus onboarding paperwork (HIPAA forms, authorizations, disclosures). We handle the complete handoff to your attorneys with all documentation complete, so intake becomes signed retainers, not just phone numbers.",
  },
  {
    id: 4,
    question: "What's the difference between specialized legal intake services and generic call centers?",
    answer:
      "Specialized legal intake uses teams trained on legal case criteria across all practice areas, with clinicians for medical review when needed. Generic call centers do basic message‑taking. You get domain knowledge, 24/7 coverage without weekend premiums, elastic scaling, and retainer‑to‑onboarding workflows, not just name and number.", },
  {
    id: 5,
    question: "How do law firms work with intake specialists and their existing marketing agency?",
    answer:
      "Intake specialists integrate seamlessly with agencies like CAMG or Bridge Legal. The agency drives campaigns; intake specialists handle calls, qualification, retainer signing, and documentation. Your marketing spend converts to signed cases instead of exposing intake gaps to agency clients.",
  },
  {
    id: 6,
    question: "How quickly can a law firm start with outsourced legal intake specialists?",
    answer:
      "Simple programs launch in 1–2 weeks after aligning scripts, criteria, and system access. Complex multi‑practice or high‑volume rollouts phase in over 3–4 weeks to protect existing workflows while adding coverage where you need it most (after‑hours, weekends, overflow).",
  },
];
