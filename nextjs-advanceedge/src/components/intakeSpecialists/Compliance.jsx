  ...
  return (
    <section className="relative py-10 md:py-20 px-5 overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div
          className="flex justify-center flex-col   mt-16 opacity-0 animate-fadeInUp"
          style={{
        ...
        >
             {/* Title */}
             <h3 className="text-2xl font-medium text-[#FF7500] mb-2 group-hover:text-[#FF9A28] transition-colors duration-300">
             Important Notice:
                </h3>

                {/* Description */}
                <p className="text-gray-600 leading-relaxed text-base">
                AdvanceEdge does not provide legal advice. Intake is performed strictly based on client-provided scripts and qualification criteria. Our specialists document information and apply your evaluation standards—all case decisions remain with your legal team.
                </p>
    </div>
        {/* CTA Section */}
        <div
