...
export default function MedicalRecordHero() {
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <div className="relative w-full aspect-[4/4]">
                <Image
                  src="/litigation-teams/medical-record-review.webp"
          ...
          >
            ...
            >
              Medical Record Retrieval for Law Firms & Legal Marketing Agencies
            </motion.h2>
            ...
            >Structured, HIPAA‑aware medical record retrieval for Mass Tort, PI, MVA,
             malpractice, and complex injury cases powered by a verified 90k+ facility
              database, digital retrieval platforms, and AI‑assisted workflows.
            ...
            >
              For most plaintiff‑side firms, the real bottleneck isn’t drafting
               demands or arguing motions; it’s waiting on hospitals, clinics, 
               and pharmacies to send complete medical records. Requests get rejected 
               for minor errors, stuck in fax queues, or lost inside portal logins. 
               AdvanceEdge runs medical record retrieval for law firms as a dedicated
                function, not a side task: a verified database of 90k+ U.S. facilities
                 and copy services, disciplined follow‑up, and tight integration with
                  your Intake Specialists & Contact Center, Case Qualification, and Medical Record Review.
            </motion.p>
             {/* CTA Button */}
