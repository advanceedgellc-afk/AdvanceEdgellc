 ...
 * * A responsive, dark-themed hero section designed for a litigation-focused 
 * legal service landing page.
 */
    ...
    <section className="relative w-full lg:min-h-[80vh] min-h-[100vh]  pt-32 pb-10 flex items-center justify-center overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          ...
          alt="Medical record retrieval background" 
      ...
      <div className="relative z-10 container mx-auto px-6 py-16 md:py-24">
        ...
        <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
          Structured, HIPAA‑aware medical record retrieval for Mass Tort, PI, MVA, malpractice, and complex injury cases powered by a verified 90k+ facility database, digital retrieval platforms, and AI‑assisted workflows.
        </p>
