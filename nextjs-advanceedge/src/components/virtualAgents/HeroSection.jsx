    ...
    <section className="relative w-full lg:min-h-[80vh] min-h-[100vh]  pt-32 pb-10 flex items-center justify-center overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          ...
          alt="Virtual team and professional productivity" 
      ...
      <div className="relative z-10 container mx-auto px-6 py-16 md:py-24">
        ...
        {/* Subheading */}
        <p className="text-2xl md:text-3xl font-semibold text-slate-200 mb-8 max-w-3xl mx-auto leading-relaxed">
          Hire Skilled Virtual Agents Today!
        </p>
