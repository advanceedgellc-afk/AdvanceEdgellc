...
import { Bookmark, Users, MessageSquareText, TrendingUp } from 'lucide-react';
...
export default function VaasOnboardingSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      icon: TrendingUp,
      description: 'We provide ongoing support and adjustments to maximize productivity and ensure success.'
    }
  ];
                ...
                <div className="relative">
                  ...
                  <div className="bg-white rounded-2xl p-6 pb-20 transition-all duration-300 group-hover:shadow-xl group-hover:-translate-y-2">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      {/* Icon Background */}
                      <div className="w-12 h-12 bg-[#FFF5EB] rounded-lg flex items-center justify-center group-hover:bg-[#FF9A28] group-hover:text-white group-hover:scale-110 transition-all duration-300">
                        <IconComponent
                          size={24}
                          className="text-[#FF9A28] group-hover:text-white"
                          strokeWidth={1.5}
                        />
                      </div>
                    </div>
