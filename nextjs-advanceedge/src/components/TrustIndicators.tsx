...
import { Gauge, Stethoscope, Shield } from 'lucide-react';
...
export default function TrustIndicators() {
  ...
  const indicators = [
    ...
    },
    {
      ...
      subtitle:
        'Leveraging deep knowledge and cutting-edge solutions in Mass Torts and beyond to optimize complex litigation practices.',
      delay: 0.4,
    },
  ];
          ...
          {indicators.map((indicator, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="mb-5">
                  <div
                    className={`
                      ...
                      rounded-2xl bg-orange-500/10 text-orange-500
                ...
                {/* Title */}
                <h2 className="text-xl md:text-2xl font-semibold text-slate-900 mb-3 leading-snug">
                  {indicator.title}
                </h2>
